...
const portfolioItems = [
  {
    // TODO: Add OZo Ads poster image → replace '' with '/images/ozo-ads-poster.png'
    title: 'OZo Ads',
    desc: 'OOH advertising website design for OZo, showcasing innovative outdoor advertising solutions.',
    img: '/images/Ozo_thumnail.png',
    href: '/casestudies/ozo-ads',
  },
  {
    title: 'PlaySpot',
    desc: 'UX-UI design for sports venue booking web app',
    img: '/images/playspot-poster.png',
...
export default function PortfolioPage() {
  ...
  const cardRefs = portfolioItems.map(() => useRef<HTMLDivElement>(null))
